	...
	pi.registerTool({
		...
		async execute(_toolCallId, _params, _signal, _onUpdate, ctx: ExtensionContext) {
			...
			const lines = [
				...
				`| pending_evidence | ${status.pendingEvidenceCount} |`,
				`| processing_evidence | ${status.processingEvidenceCount} |`,
			...
			return {
				...
				details: {
					...
					pendingEvidenceCount: status.pendingEvidenceCount,
					processingEvidenceCount: status.processingEvidenceCount,
